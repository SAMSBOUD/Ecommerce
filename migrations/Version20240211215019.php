 ...
 */
final class Version20240211215019 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE product (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, slug VARCHAR(255) NOT NULL, description VARCHAR(255) NOT NULL, more_description LONGTEXT DEFAULT NULL, additional_infos LONGTEXT DEFAULT NULL, stock INT DEFAULT NULL, solde_price INT NOT NULL, regular_price INT NOT NULL, image_urls LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\', brand VARCHAR(255) DEFAULT NULL, status VARCHAR(255) DEFAULT NULL, is_available TINYINT(1) DEFAULT NULL, is_best_seller TINYINT(1) DEFAULT NULL, is_new_arrival TINYINT(1) DEFAULT NULL, is_featured TINYINT(1) DEFAULT NULL, is_special_offer TINYINT(1) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
